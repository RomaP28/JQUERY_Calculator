...
$(function () {
  ...
  function addLog(expression, result) {
    //-------------------если выражение содержит число 48 то добавляем подчеркивание(по условию задачи)--------------------------------
    ...
    //-------------------проверяем если на прокрутка то выводим результат в консоль(по условию задачи)--------------------------------
